...
func (rb rustBuffer) free() {
	rustCall(func(status *C.RustCallStatus) bool {
		C.ffi_math_14e3_rustbuffer_free(rb.self, status)
		return false
	})
}
...
func Add(a uint32, b uint32) uint32 {
	...
	return FfiConverteruint32INSTANCE.lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.math_14e3_add(FfiConverteruint32INSTANCE.lower(a), FfiConverteruint32INSTANCE.lower(b), _uniffiStatus)
	}))
